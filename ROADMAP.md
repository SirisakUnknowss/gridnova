...
|---|---|---|---|---|
| 1 | **เก็บ referrer + UTM** ลง `visitor_sessions` | ทำซ้ำ spike ที่หาที่มาไม่ได้ ไม่ได้ · เพิ่ม 1 คอลัมน์ + capture ตอนสร้าง session + กราฟใน admin · ทุกชั่วโมงที่ผ่านไปคือข้อมูลที่หายถาวร | ~2 ชม. | 🔨 |
